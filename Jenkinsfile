        ...
        stage ('Release') {
            steps {
                script{
                    ...
                    sh 'Release_Details=$(curl -XPOST -H "Authorization:token $token" --data \'{"tag_name":"v1.0.0","target_commitish":"main","name":"Release v1.0.0","body":"First release of caesar-cipher","draft":false,"prerelease":false}\' https://api.github.com/repos/nityapisharodi/caesar-cipher/releases)'
